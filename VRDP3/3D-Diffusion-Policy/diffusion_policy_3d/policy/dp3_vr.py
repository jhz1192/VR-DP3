...
from diffusion_policy_3d.model.diffusion.conditional_unet1d_vr import ConditionalUnet1D
...
class DP3VR(BasePolicy):
    ...
    def get_kl_weight(self, step, kl_warmup_step):
        current_kl = self.max_kl_beta / kl_warmup_step * step
        return min(self.max_kl_beta, current_kl)
